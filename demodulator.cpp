...
float demodulator::get_timing_offset()
{
	return this->gardner.get_resampling_fraction();
}


float demodulator::get_frequency_offset()
{
	return this->costas.get_phase_increment();
}
